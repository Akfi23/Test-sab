...
public class BattleControllerSystem : GameSystem
{
    ...
    {
        StartCoroutine(OnEnemyDie(victim,killer));
    }

    private IEnumerator OnEnemyDie(MonsterComponent victim,MonsterComponent killer)
    {
        yield return null;
